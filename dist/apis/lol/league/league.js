...
class LeagueApi extends base_api_lol_1.BaseApiLol {
    ...
    byPUUID(puuid, region) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.request(region, endpoints_1.endpointsV4.LeagueByPUUID, params);
        });
    }
    /**
     ...
     */
    entries(queue_1, tier_1, division_1, region_1) {
        return __awaiter(this, arguments, void 0, function* (queue, tier, division, region, page = 1) {
            const params = {
                queue,
                tier,
                division
